...
public class BuyCommand implements CommandExecutor {
	...
	public Inventory GUI(Player player, double money) {
		...
		if (player.isOp()) {
			player.sendMessage(
					Main.Prefix + Main.color("&cYou are OP. GUI MAY NOT WORK AS EXPECTED. TO TEST DEOP YOURSELF."));
			Inventory opinv = Bukkit.createInventory(null, 9, Main.color("&4YOU ARE OP."));
			opinv.setItem(4, ItemMaker.createItemStack("&4You are OP", "BARRIER", "&bThe GUI WILL NOT WORK RIGHT",
					"&bWHEN YOU ARE OP."));
			return opinv;
		}
		// One
		if (checkPermissions(player, "commands.buycommand.commands.one.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.one.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.one.name"),
						main.getConfigString("commands.buycommand.commands.one.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.two.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.two.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.two.name"),
						main.getConfigString("commands.buycommand.commands.two.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.three.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.three.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.three.name"),
						main.getConfigString("commands.buycommand.commands.three.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.four.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.four.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.four.name"),
						main.getConfigString("commands.buycommand.commands.four.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.five.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.five.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.five.name"),
						main.getConfigString("commands.buycommand.commands.five.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.six.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.six.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.six.name"),
						main.getConfigString("commands.buycommand.commands.six.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.seven.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.seven.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.seven.name"),
						main.getConfigString("commands.buycommand.commands.seven.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.eight.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.eight.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.eight.name"),
						main.getConfigString("commands.buycommand.commands.eight.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.nine.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.nine.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.nine.name"),
						main.getConfigString("commands.buycommand.commands.nine.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.ten.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.ten.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.ten.name"),
						main.getConfigString("commands.buycommand.commands.ten.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.eleven.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.eleven.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.eleven.name"),
						main.getConfigString("commands.buycommand.commands.eleven.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.twelve.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twelve.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twelve.name"),
						main.getConfigString("commands.buycommand.commands.twelve.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.thirteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.thirteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.thirteen.name"),
						main.getConfigString("commands.buycommand.commands.thirteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.thirteen.price"))));
			}
		}
		// Fourteen
		if (checkPermissions(player, "commands.buycommand.commands.fourteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.fourteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.fourteen.name"),
						main.getConfigString("commands.buycommand.commands.fourteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.fourteen.price"))));
			}
		}
		// Fifteen
		if (checkPermissions(player, "commands.buycommand.commands.fifteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.fifteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.fifteen.name"),
						main.getConfigString("commands.buycommand.commands.fifteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.fifteen.price"))));
			}
		}
		// Sixteen
		if (checkPermissions(player, "commands.buycommand.commands.sixteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.sixteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.sixteen.name"),
						main.getConfigString("commands.buycommand.commands.sixteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.sixteen.price"))));
			}
		}
		// Seventeen
		if (checkPermissions(player, "commands.buycommand.commands.seventeen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.seventeen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.seventeen.name"),
						main.getConfigString("commands.buycommand.commands.seventeen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.seventeen.price"))));
			}
		}
		// Eighteen
		if (checkPermissions(player, "commands.buycommand.commands.eighteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.eighteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.eighteen.name"),
						main.getConfigString("commands.buycommand.commands.eighteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.eighteen.price"))));
			}
		}
		// Nineteen
		if (checkPermissions(player, "commands.buycommand.commands.nineteen.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.nineteen.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.nineteen.name"),
						main.getConfigString("commands.buycommand.commands.nineteen.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.nineteen.price"))));
			}
		}
		// Twenty
		if (checkPermissions(player, "commands.buycommand.commands.twenty.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twenty.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twenty.name"),
						main.getConfigString("commands.buycommand.commands.twenty.material"),
						Main.color("&fClick to purchase."),
		...
		if (checkPermissions(player, "commands.buycommand.commands.twentyone.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentyone.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.twentyone.name"),
						main.getConfigString("commands.buycommand.commands.twentyone.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.twentyone.price"))));
			}
		}
		// Twenty-two
		if (checkPermissions(player, "commands.buycommand.commands.twentytwo.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentytwo.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.twentytwo.name"),
						main.getConfigString("commands.buycommand.commands.twentytwo.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.twentytwo.price"))));
			}
		}
		// Twenty-three
		if (checkPermissions(player, "commands.buycommand.commands.twentythree.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentythree.name").equalsIgnoreCase("null")) {
				inv.addItem(
						ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twentythree.name"),
								main.getConfigString("commands.buycommand.commands.twentythree.material"),
								Main.color("&fClick to purchase."), Main.color("&7Cost: "
										+ main.getConfig().getInt("commands.buycommand.commands.twentythree.price"))));
			}
		}
		// Twenty-four
		if (checkPermissions(player, "commands.buycommand.commands.twentyfour.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentyfour.name").equalsIgnoreCase("null")) {
				inv.addItem(
						ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twentyfour.name"),
								main.getConfigString("commands.buycommand.commands.twentyfour.material"),
								Main.color("&fClick to purchase."), Main.color("&7Cost: "
										+ main.getConfig().getInt("commands.buycommand.commands.twentyfour.price"))));
			}
		}
		// Twenty-five
		if (checkPermissions(player, "commands.buycommand.commands.twentyfive.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentyfive.name").equalsIgnoreCase("null")) {
				inv.addItem(
						ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twentyfive.name"),
								main.getConfigString("commands.buycommand.commands.twentyfive.material"),
								Main.color("&fClick to purchase."), Main.color("&7Cost: "
										+ main.getConfig().getInt("commands.buycommand.commands.twentyfive.price"))));
			}
		}
		// Twenty-six
		if (checkPermissions(player, "commands.buycommand.commands.twentysix.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentysix.name").equalsIgnoreCase("null")) {
				inv.addItem(ItemMaker.createItemStack(
						main.getConfigString("commands.buycommand.commands.twentysix.name"),
						main.getConfigString("commands.buycommand.commands.twentysix.material"),
						Main.color("&fClick to purchase."), Main.color(
								"&7Cost: " + main.getConfig().getInt("commands.buycommand.commands.twentysix.price"))));
			}
		}
		// Twenty-seven
		if (checkPermissions(player, "commands.buycommand.commands.twentyseven.permissions")) {
			if (!main.getConfigString("commands.buycommand.commands.twentyseven.name").equalsIgnoreCase("null")) {
				inv.addItem(
						ItemMaker.createItemStack(main.getConfigString("commands.buycommand.commands.twentyseven.name"),
								main.getConfigString("commands.buycommand.commands.twentyseven.material"),
								Main.color("&fClick to purchase."), Main.color("&7Cost: "
										+ main.getConfig().getInt("commands.buycommand.commands.twentyseven.price"))));
			}
		}
		return inv;
	}
	 ...
	 * @return | returns true if found a permission the player doesn't have. returns
	 *         false if player already has all permissions.
	 */
